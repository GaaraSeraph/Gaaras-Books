...
*Kanon. Wer diese Menschen sind. Praesens ueber die Fiktion.*

**Wie man eine Figur baut, steht nicht hier, sondern in `21-figurenbau.md`.
Wie sie spricht, in `12-stimmen.md`.** Hier steht, wer sie ist.

Zusammengelegt am 27.08. aus `02-leads` (Praemisse und die beiden Hauptfiguren)
und `03-cast` (alle uebrigen). Sie standen getrennt, seit die Ablage
`doc/01` bis `doc/08` hiess, und `08-decisions` musste dazu eigens festhalten,
welches von beiden bei einem Widerspruch massgeblich ist. **Jetzt gibt es
keinen Widerspruch mehr, weil es eine Datei ist.**
...
über vier Pflanzungen lesbar - siehe `doc/15-kalender.md`, Abschnitt „Die
...
**Und die Grenze bleibt, was sie war:** `doc/11-figuren.md` sagt, wo sein
...
**Wie man das liest:** die Tabelle unten ist der Index. Wer eine Szene schreibt,
sucht die Figur dort, springt in ihren Abschnitt und liest **`doc/12-stimmen.md`
dazu** - dort steht, wie sie spricht und was sie will, das mit dem Fall nichts zu
tun hat. Die Spalte **Stand** sagt, ob sie noch im Spiel ist; das ist die Spalte,
die beim Planen zaehlt.
...
**Ihr Geschäft:** Ein Chaebol mit mehreren Sparten, von denen bisher nur eine aufgedeckt ist, weil nur eine gebraucht wird. Die relevante ist Spezialchemie und Werkstoffe. Fahrplangebundene Vorprodukte über wenige Häfen, und die schwierigen Auslandszulassungen, die sie braucht, liegen bei den Kims. Sie ist also abhängig und keine Wohltäterin. Was sie mit dem Vetorecht über Routen tatsächlich kauft, ist eine Engstelle, an der drei oder vier Konkurrenten derselben Branche hängen. Einzelheiten in `doc/14-welt.md` unter "Was Annies Gruppe macht, und was sie wirklich kauft".
*Kanon.*

**Georgij** - Los vierzehn. Siehe `doc/11-figuren.md`, Abschnitt "Georgij".
*Kanon.*
...
**Der erste Wachmann** - Namenlos. Verliert das Auge. Laengere Fassung weiter unten in dieser Datei, Begruendung in `doc/11-figuren.md` unter "Das Auge: warum, und warum nicht die Kehle".
...
Die Mechanik dahinter steht in `doc/14-welt.md` unter "Das Geschaeft".
...
**Ihr eigener Einsatz: Lagerflächen in Incheon**, deren Wert am Status des Geländes hängt, den sie letztes Jahr selbst durchgedrückt hat. Sie sagt das niemandem. Georgij findet es selbst, über ihre eigene Formulierung auf der Terrasse und einen Nachmittag im Grundbuch. Ihr Name steht offen darin, sie hat nichts versteckt. Was ihn beschäftigt, sind die Belastungen und die Gläubiger. Einzelheiten in `doc/14-welt.md` unter "Hana: was sie einbringt und was sie dafuer bekommt".
...
weil er Georgijs Spiegel ist.** Ueber Georgij steht in `doc/31-plan-band-2.md`: *"Er
...
verworfen (siehe Regel 2i in `doc/20-handwerk.md`). **Damit steht sie noch zur
...
der Nam-Gruppe in Ulsan, die laut `doc/14-welt.md` auf denselben zwei Lanes
...
zu verhandeln gab. Der Kanon steht dem nicht im Weg: `doc/14-welt.md` nennt vier
...
`doc/11-figuren.md`, Zeile "Digitale Sicherheit". Der Band hat sich sein eigenes
...
Mitwisser im Buch.
*Kanon, Band 2 Kapitel 6, 28, 30, 32.*
...
**Mr Koh** - **Umbenannt am 25.08.** Hiess bis dahin **Mr Ryu** und kollidierte mit Mrs Ryu aus Band 1, Kapitel 7. **Der Satz sagte bis zum 07.09., er habe bis dahin Mr Koh geheissen, und widersprach sich damit selbst.** Der Erste von Annies
