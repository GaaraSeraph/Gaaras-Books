...
Der laufende Bericht steht in `doc/14-stilprotokoll.md`, die Blätter in
`doc/12-stimmen.md`.
...
| | |
|---|---|
| **Regel** | unverändert, `doc/01-craft.md`: *"Steht er in Fragesyntax … kommt ein Fragezeichen hin, egal wie kalt er ist."* |
