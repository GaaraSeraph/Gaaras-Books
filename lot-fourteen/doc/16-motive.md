# Motive und festgelegte Zeilen

*Kanon. Was im Buch wiederkehrt und wortgleich bleiben muss.*

**Eine festgelegte Zeile ist Wortlaut.** Wer sie umformuliert, toetet einen
Reim, den keine Suche von selbst findet - deshalb steht bei jeder, warum sie
traegt und wie oft sie fallen darf.
...
Fehler, ein ruinierter Mann. `doc/11-figuren.md`: *"fuehrt durch Auswahl in die
Irre."*
...
- **Das freundlichere, je schlimmer es wird.** *Zurückgestellt, nicht offen.*
  `doc/11-figuren.md` führt den Grundsatz seit Anfang: je zuvorkommender er wird,
...
- **Das kalte.** *Offen, und die nächste Gelegenheit steht schon fest.* Kein
  ...
  **Die Stelle ist das Gespräch mit den Kims**, das in `doc/31-plan-band-2.md` als
...
Ausführlich in `doc/11-figuren.md` unter **Er lügt nie**.
...
71. **Der Satz, der durch das Buch laeuft: "It has been good to see you again."** Kanonwortlaut und Genauigkeitsauflage stehen in b2 K29, **ohne** *very* (*"Say the sentence exactly."*). b2 K50, K76 und K80 tragen die verkuerzte Erinnerung; der Zielpunkt in b2 K86 nimmt den exakten Satz wieder auf.
72. **Die Varianten desselben Tics, drei unabhaengige Zeugen:** Mr Ok (b2 K16) *"glad we had finally met"*, Chairman Woo (b2 K13), Mr Yeom (b2 K24) *"glad we had met"*, Mrs Gwak (b2 K29) *"It has been good to see you again"* - **jedes Mal zu Menschen, die er nie getroffen hat.** Die Probe dazu: *"A habit shared by two different men is a coincidence. A habit that specific, said in that exact shape, twice, four years apart, is not a coincidence twice."*
...
92. **Zwei Urteile ueber denselben Mann, und das Buch faellt keines davon:** Byun, *"Then you are a very cruel young man"* (b2 K21) gegen Mrs Jeon, *"You are a very strange young man"* (b2 K30).
