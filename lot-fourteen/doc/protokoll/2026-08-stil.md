# Stilprotokoll, August 2026

*Archiv. Append-only. Gewinnt bei einem Widerspruch nie - siehe `LIESMICH.md`.*

**Ausgezogen am 27.08. aus `doc/14-stilprotokoll.md`**, Abschnitt *Durchgaenge*
bis Dateiende. Was dort vorne stehenblieb, sind die Regeln der Stilpruefung
(was gemeldet wird, wie erfundene Repliken markiert werden, die zwei nicht
verhandelbaren Regeln). Die wandern in Schritt 4 nach `22-pruefen`.

Hier steht, was die Stilsitzungen zwischen dem 24. und dem 27. August
tatsaechlich getan haben: die Durchgaenge, die Gegenlesungen von `doc/12`, die
Berichtigungen, die Fehlschlaege.

---

**Aus `doc/14-stilprotokoll.md`, ausgezogen am 27.08.**
