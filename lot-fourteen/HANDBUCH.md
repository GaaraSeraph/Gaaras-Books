...
Alle 9 Dokumente am Stueck plus das Begegnungsregister. 171.746 Woerter.
...
- [Handwerk](#handwerk)  ·  `doc/01-craft.md`
  ...
  - [2i. Der Bogen darf keine Ratsche sein](#2i-der-bogen-darf-keine-ratsche-sein)
  ...
  - [Zuerst, weil es am meisten kostet](#zuerst-weil-es-am-meisten-kostet)
  - [Zeitangaben](#zeitangaben)
  - [Rueckverweise](#rueckverweise)
  ...
  - [Fehler bleiben Fehler - im Text, nicht am Manuskript](#fehler-bleiben-fehler-im-text-nicht-am-manuskript)
  - [Ihre Repliken](#ihre-repliken)
  - [Zahlen](#zahlen)
  - [Zuletzt](#zuletzt)
- [Praemisse, Georgij, Annie](#praemisse-georgij-annie)  ·  `doc/02-leads.md`
  - [Prämisse](#pr-misse)
  - [Quid pro quo](#quid-pro-quo)
  - [Die Kette zwischen den beiden, und wie oft sie faellig ist](#die-kette-zwischen-den-beiden-und-wie-oft-sie-faellig-ist)
  - [Die Rangordnung im Haus, und sie ist absolut](#die-rangordnung-im-haus-und-sie-ist-absolut)
  - [Die Legende: der Berater](#die-legende-der-berater)
  - [Charme als Werkzeug](#charme-als-werkzeug)
  - [Das Achselzucken](#das-achselzucken)
...
- [Kontinuitaet](#kontinuitaet)  ·  `doc/05-continuity.md`
  ...
  - [Geprueft und stehengelassen](#geprueft-und-stehengelassen)
...
- [Stoffbloecke](#stoffbloecke)  ·  `doc/06-plot.md`
  ...
  - [[KORRIGIERT] Die östlichen Rosen sind keine tote Zone](#korrigiert-die-stlichen-rosen-sind-keine-tote-zone)
  - [Block B - Protokoll **[GESCHRIEBEN, Kapitel 4, 5, 6]**](#block-b-protokoll-geschrieben-kapitel-4-5-6)
  - [Der Gala-Abend **[GESCHRIEBEN, Kapitel 6 bis 11]**](#der-gala-abend-geschrieben-kapitel-6-bis-11)
  - [Block C - Die Gala **[GESCHRIEBEN, Kapitel 7 bis 11]**](#block-c-die-gala-geschrieben-kapitel-7-bis-11)
  - [Was der Plan nicht hatte](#was-der-plan-nicht-hatte)
  - [Die Lücke: Tag 45](#die-l-cke-tag-45)
  - [Block D - Frühstück **[ÜBERHOLT]**](#block-d-fr-hst-ck-berholt)
  - [Block E - Kang Ji-hoon **[TEILS GESCHRIEBEN, Kapitel 12]**](#block-e-kang-ji-hoon-teils-geschrieben-kapitel-12)
  - [Block F - Arbeitszimmer **[AUFGELOEST, nicht geschrieben]**](#block-f-arbeitszimmer-aufgeloest-nicht-geschrieben)
  - [Block G - Der Bruch **[GESCHRIEBEN, Kapitel 22 bis 24]**](#block-g-der-bruch-geschrieben-kapitel-22-bis-24)
...
- [Naechste Schritte und offene Faeden](#naechste-schritte-und-offene-faeden)  ·  `doc/07-next.md`
  ...
  - [2. Die Haende: Sim und die Mittelsmaenner](#2-die-haende-sim-und-die-mittelsmaenner)
  - [3. Der Tisch: die dreiundzwanzig Jahre](#3-der-tisch-die-dreiundzwanzig-jahre)
  - [4. Das Vehikel: Hongkong und Singapur](#4-das-vehikel-hongkong-und-singapur)
  - [5. Das Haus: die Losnummer kommt zu Akte](#5-das-haus-die-losnummer-kommt-zu-akte)
  - [6. Die Staatsanwaltschaft: warum er frueh ging](#6-die-staatsanwaltschaft-warum-er-frueh-ging)
  - [Die Reihenfolge, und sie ist erzwungen](#die-reihenfolge-und-sie-ist-erzwungen)
...
- [Arbeitsteilung: Stil und Inhalt](#arbeitsteilung-stil-und-inhalt)  ·  `doc/09-arbeitsteilung.md`
  - [Was wirklich kollidiert](#was-wirklich-kollidiert)
...
# Praemisse, Georgij, Annie

Der Vertrag und die zwei, um die es geht. Bei jeder Szene mit einem der beiden.

---

## Praemisse und Vertrag

Worum es geht und was zwischen den beiden gilt. Alles Weitere haengt hieran.

### Prämisse
Südkorea, Gegenwart. Chaebol-Milieu. Georgij wird auf einer illegalen Schuldübernahme-Auktion von Annie gekauft und wird ihr Schatten: Begleiter, Beobachter, und was sonst nicht ausgesprochen wird.

### Quid pro quo

Der zentrale Satz. Georgij bringt ihn im Wagen an: Eine Schuldübernahme ist ein Vertrag, und ein Vertrag hat zwei Seiten, auch wenn eine davon ein Halsband trägt. Respekt gegen Gehorsam.

Er verhandelt damit nicht, er beschreibt. Es ist seine einzige Möglichkeit, sich selbst zu gehören, während ihn jemand besitzt.

Annie nimmt den Satz im Wagen weder an noch ab. Sie kontert nur, sie habe nicht für einen Geschäftspartner bezahlt, sondern für etwas, das sie kontrollieren kann. Seine Antwort ist "Naturally" und die Zahl vierundneunzig.

**Einlösung in Kapitel 2, Auffahrt.** Georgij holt den Satz zurück und macht ihn konkret: Der Wachmann hat keine eigene Autorität, also geschah alles in ihrem Namen. Der Hund. Der Knopf, zweimal. *"By the terms, that was you."* Es ist ausdrücklich keine Beschwerde. Hätte er es im Wagen gesagt, hätte sie den Mann gemaßregelt und er wäre ein Jahr lang das Ding gewesen, wegen dem jemand gemaßregelt wurde. Er hat stattdessen die Hand abgenommen und den Rest von ihr in Ruhe gelassen. Das ist die gehorsamste verfügbare Fassung des Abends.
...
Die Figur, ihre Regeln und ihre Grenzen. Wer eine Szene mit ihm schreibt,
...
**Registerbild: Daemon Sadi.** Seide über einer Klinge. Makellose Höflichkeit als Waffe. Je zuvorkommender er wird, desto näher ist jemand am Schaden. Theatralische Verbeugungen, ein halbes Grinsen, elegante kleine Gesten. Er dient, ohne sich zu unterwerfen.

**Akte:** "Komplexer Charakter. Gewalttätig." Das ist nicht wahr und nicht ganz falsch. In zwei Häusern hat jemand Hand an ihn gelegt und es bereut. Wenn ein Mann mit Halsband im eigenen Korridor an den Leuten des Hauses vorbeikommt, gibt es zwei mögliche Zeilen für die Akte. Eine kostet das Haus seinen Ruf. Sie haben nie diese gewählt. Und "komplexer Charakter" hebt den Preis, also hat es nie jemand korrigiert.
...
### Die Legende: der Berater

**Kanon ab Kapitel 7.** Auf der Gala hält der Saal Georgij für Annies Analysten oder Berater. Das erklärt, warum er Tonnagen, Schiedssprüche und Quartalszahlen kennt, und macht aus seiner gefährlichsten Eigenschaft die plausibelste.

**Es ist keine Lüge.** Er berät sie tatsächlich, seit weniger als einem Jahr, und sonst niemanden. Jeder Satz wahr, keiner je zurückzunehmen.
...
**Zwei Prüfungen kommen darauf zu.** Erstens die harmlose: Irgendwann stellt jemand vor Publikum eine Frage mit einer Zahl darin, um zu sehen, ob er echt ist. Darauf freut er sich. Zweitens die teure, und die kommt von jemand Freundlichem: *"And who were you with before?"*

### Charme als Werkzeug

Er spielt den leicht übereifrigen, von so viel Macht beeindruckten Begleiter, und zwar bei jedem im Saal, damit die Fassade stimmig ist. Dass ein paar es durchschauen, nimmt er in Kauf.

**Es besteht aus wahren Dingen.** Er kennt Erfolge und Hobbys aus dem Dossier, also muss er nichts erfinden. Er **behauptet** aber nie, was er weiß, sondern **fragt** danach. Eine Frage verrät, dass er etwas weiß. Eine Behauptung verrät, wie viel, wie aktuell und woher.

**Nie die berühmte Sache.** Die loben alle seit vier Jahren. Er greift nach der jüngsten: die Tonnage von vor sechs Wochen, das Urteil vom März, die kleine hässliche Übernahme, die noch nicht Teil der Legende ist.

**Das Lächeln.** Es wird nie erklärt, nur benutzt, und die Sorten unterscheiden sich am Empfänger.
...
**Was es kostet:** In der ersten Stunde glänzend, ab der zweiten haben achthundert Leute verglichen. Bis Mitternacht ist der Charme nichts mehr wert und das Gesicht sehr viel, denn jeder, den er heute erfreut, kann ihn in vierzehn Tagen beschreiben.

### Das Auge: warum, und warum nicht die Kehle

Zwei getrennte Fragen, im Text auch getrennt beantwortet.

**Warum überhaupt.** Zwei Dinge zusammen. Erstens sachlich: Der Mann hat gedrückt, ohne dass es ihm jemand befohlen hat. Er hat keine eigene Autorität, also hat er in Annies Namen an etwas gehandelt, das sie vier Stunden besaß, auf eine Vermutung über ihre Laune. Georgij selbst rät ständig, das ist der Job, aber wenn er sich irrt, ist er selbst die Sicherheit, und beim Wachmann liegt auf dessen Seite des Tisches nichts, woraus man es nehmen könnte. Zweitens persönlich, etwa die Hälfte: Hund seit dem Ladehof, und dann zweimal Strom vor der Frau, der er gehört. Jedes für sich hätte er ins Haus getragen. Beides zusammen, von einem Mann, der nicht gut genug war für eines von beiden, nicht.

Georgij verschweigt keine der beiden Hälften. Er sagt von sich aus "Half of it is professional", und wenn sie nach der anderen fragt, kommt sie ohne Zögern.

**Was aus dem Wachmann wird.** Er überlebt. Das ist gesetzt und nicht verhandelbar, weil Georgijs eigene Begründung daran hängt. Mrs Seo ruft von der Auffahrt aus eine Nummer, die sie auswendig kann, unter einer Minute und ohne Adresse. Kein Krankenwagen, weil ein Krankenwagen ein Krankenhaus bedeutet und eine penetrierende Augenverletzung dort als Gewalttat gemeldet wird, und Annie kann an diesem Abend keine Polizei am Tor gebrauchen. Georgij kann in Kapitel 3 nicht entscheiden, ob jemand ein Krankenhaus ausgesucht hat oder ob der Mann in gar keins geht. Wir wissen es.

**Warum das Auge statt der Kehle.** Eine Leiche wäre ihre geblieben, in einem Monat und in einem Jahr und vor Leuten, die sie sich nicht ausgesucht hat. Der Einäugige trägt es selbst, in jedes Vorstellungsgespräch, das er je führt. Der Nachfolger hat die ganze Geschichte gehört, bevor er ankommt, und Georgij will diesen Abend nicht zweimal.
...
**Sie schaut hin.** Im Wagen wendet sie den Blick kein einziges Mal ab, und in der Auffahrt dreht sie sich um und sieht sich das Auge an, ohne sich zu bewegen und ohne einen Laut.
...
**Namensregel:** In der Öffentlichkeit "Annie". Sonst nirgends. Privat ist er Eigentum und sagt "Mistress". Ein Regelbruch in die eine oder andere Richtung hören beide sofort.
...
**Der Name des Garanten.** Sie hat ihn. Sie hat ihn seit fast der ganzen Zeit, die Georgij im Haus ist, weil er ihr am ersten Abend gesagt hat, dass das Fenster drei Wochen offen steht. Er spricht sie in Kapitel 11 darauf an, geradeheraus und ohne Verpackung, weil sie ihn in Kapitel 6 dafür gerügt hat. Sie bestätigt, dass sie ihn hat, und gibt ihn nicht heraus. Ihre Begründung, auf seine Nachfrage:

> "Because I've looked at it, and it changes what I am going to have to ask you to do."
...
**Die Frühstücksfrage, gelöst.** Annie kommt an zwei Morgen in die Küche und danach nicht mehr. Mrs Seos Tablett geht weiter um sieben hinauf, für Georgij wird am Personaltisch gedeckt, und an den Morgen, an denen Annie ihn will, schickt sie Ji-won. Keine der beiden Frauen spricht mit der anderen darüber. Georgij hält das für das Erste im Haus, das er selbst nicht hinbekommen hätte.
- **Die Geräte.** Laptop und Telefon, am ersten Morgen unaufgefordert von Annie. Beide verwaltet, alles läuft zu einer Firma zurück, die ihr monatlich Rechnungen schickt. Sie sagt es ihm selbst, statt ihn es finden zu lassen. Er sagt zu, so darauf zu schreiben, als lese sie mit.
- **Der Kragen.** Der Schneider misst über dem Halsband und sagt kein Wort dazu. Stehkragen vier Zentimeter höher als üblich, Haken und Öse statt Knopf, Ripsband innen gegen das Scheuern. Sein einziger persönlicher Satz: Kinn waagerecht halten, nicht heben, weil Männer mit etwas am Hals das Kinn heben und dann sehen alle auf den Hals.
- **Die zwei fehlenden Kameras.** Er findet sie in der ersten Nacht mit dem Telefon, das sie ihm gegeben hat: Licht aus, Frontkamera, weil die hintere einen Filter hat, und die Infrarot-LEDs stehen als weißer Fleck im Bild. Nummer dreiundzwanzig sitzt im Türsturz über der Haustür, flacher Winkel, etwa zwei Meter Abdeckung, und in diesen zwei Metern liegen die Schlüsselschale und die Fernbedienung. Nummer vierundzwanzig sitzt in der Osttraufe und schaut nicht aufs Haus, sondern über den Rasen auf die Rosen an der Mauer. Beide hängen dort seit Jahren, das Sturzprofil ist zweimal überstrichen. Sie sind nicht seinetwegen gebaut, sondern weil das die zwei Stellen sind, für die sich jeder interessieren würde.
- **Das Haus.** Kameras in jeder oberen Zimmerecke, Neigung etwa 45 Grad, tote Zonen darunter und hinter den Säulen. Säule drei, Flurkreuzung, Eingang zur Hauptsuite. Verstärktes Glas, Rahmen im Stein. Stahltür zur Garage mit elektronischem Schloss.
- **Die Kameraanlage, vollständig.** Es gibt ein hauseigenes Monitorzimmer im Sicherheitsbüro am Garagengang: eine Wand mit acht Schirmen, die zweiundzwanzig Kameras durchschaltet. Das Archiv geht zusätzlich an den Auftragnehmer in Yeouido, wo es seit vier Jahren niemand ansieht. Die zwei zusätzlichen Kameras, Türsturz und Osttraufe, laufen auf **keiner** Wand und in **keinem** Plan. Sie existieren nur im Archiv. Deshalb weiß niemand im Haus von ihnen, deshalb steht auf Jangs Plan zweiundzwanzig, und deshalb kann Annie trotzdem vierundzwanzig sagen.
- **Mr Noh** - Sicherheitschef seit zweiundzwanzig Jahren, geht Ende des Monats, baut seit März Resturlaub ab und kommt dienstags. Er ist der Grund, warum die Anlage veraltet ist, warum es keinen schriftlichen Kameraplan gab und warum das Archiv seit vier Jahren niemand prüft. Jang kommt als **Interimschef** und war ohnehin unterwegs, unabhängig vom Auge. Georgij weiß das erst, als Jang es ihm sagt, und beansprucht den Zufall ausdrücklich nicht für sich.
- **Ihr Desktop und die Gästeliste.** Annie nennt ihm die Gäste der Gala nicht, und zwar aus Methode: Gibt sie ihm ein Dutzend Namen, bestätigt er drei Wochen lang nur, was sie ohnehin vermutet. **Ihre Arbeitsmaschine hat nie an einem Netz gehangen.** Kein Kabel, keine Karte, keine Verbindung, und darauf liegen Dinge, die außer ihr niemand sehen soll. Es gibt daran nichts zu knacken, und Georgij begreift das in den ersten drei Tagen: Er hört auf, an die Maschine zu denken, und fängt an, die Frau anzusehen. Sie tippt die Passphrase in drei Wochen zweimal vor ihm. Beim ersten Mal steht er mit dem Rücken zu ihr am Fenster und bekommt die Hälfte. Beim zweiten Mal, elf Tage später, steht er an der Schreibtischecke mit einer Mappe in den Händen und sieht auf ihre Schulter, nicht auf ihre Hände, weil Menschen spüren, wenn man auf Hände sieht. Er notiert nichts, jemals.

Er beschafft die Liste selbst und legt die Datei auf dieser Maschine ab. Wer kommt, was jeder verbirgt, wer mit wem verbunden ist. Verschlüsselt, und das Passwort ist sein Name, den sie tippen muss. Er sagt ihr von sich aus, wie er hineingekommen ist, dass der Stick aus ihrer zweiten Schublade stammt, dass die Kopie im Protokoll des Laptops steht und dass sie die Passphrase heute Nacht ändern soll, ohne jemanden im Raum. Sie sagt darauf nur "Will I". Sie fragt weder, wie er an die Namen gekommen ist, noch, was er sonst auf der Maschine gesehen hat, obwohl das Protokoll des Laptops sie eine Minute kosten würde. Genau das ist die Respekt-Hälfte des Vertrags. Er kommentiert das Vorenthalten mit keinem Wort.
- **Die Gala im Grand Hotel.** Er geht als Gast, nicht als Schatten. Aufgabe: Information. Auf Hände achten, auf Augen, wem sie zuflüstern, wenn sie denken, niemand sieht hin.
- **Ihre Dreiteilung der Gäste:** Idioten reden zu viel und hören zu wenig. Feinde lächeln, während sie nach der Schwäche suchen. Die Freundlichen sind die gefährlichsten, sie wollen etwas von ihr und benutzen ihn, um es zu bekommen.
- **Später:** Park Sang-hoon, Hana, Min-ho, die Familien Lee und Kim, Incheon, die Hanseong-Gruppe. Erst ab der Gala relevant.
...
**Der Kauf ist keine Gnade.** Georgij hat sie gebeten, den Kreislauf zu unterbrechen. Sie hat ihn fortgesetzt, mit Rabatt. Wenn er es erfährt, darf das keine Erleichterung sein.

**Der Grund ist betrieblich.** Das Haus läuft auf lebenslanger Loyalität und der Bestand vergreist: Noh zweiundzwanzig Jahre und geht, Yeo sechsundzwanzig, Mrs Ahn seit 2009. Loyalität dieser Art zieht man nicht mit Fünfunddreißigjährigen nach, die anderswo gelernt haben, wem sie gehören. Es gibt also einen Weg, auf dem junges Personal beschafft und gebunden wird, und der Junge ist die nächste Rate.
...
**Aufgedeckt wird nur, was gebraucht wird.** Für Incheon ist eine einzige Sparte relevant, und deshalb ist sie die einzige, die im Text auftaucht. Der Rest kommt nach und nach, wenn eine Handlung ihn verlangt, und nie als Aufzählung. Auch Georgij kennt nach sechs Wochen nur den Teil, an dem er arbeitet, und das ist normal und muss nicht erklärt werden.

**Genannt wird es zum ersten Mal in Kapitel 14**, in einem Nebensatz und nicht als Enthüllung: sechs Werke für Spezialchemie und Beschichtungen, und die zwei, auf die es ankommt, stellen die Vorprodukte her, auf denen alles Übrige der Gruppe aufbaut.

**Die relevante Sparte: Spezialchemie und Werkstoffe.** Die Vorprodukte sind fahrplangebunden und laufen über wenige Häfen. **Warum die Route in diesem Geschäft alles ist**, im Text ausgeschrieben: Ein Reaktor, der steht, läuft nicht am Donnerstag wieder an. Die Charge darin ist verloren, die zwei dahinter auch, und eine Anlage, die eine Woche kalt war, ist vier Wochen von brauchbar entfernt. Unter jedem Liefervertrag steht eine Lieferklausel mit einer Zahl darin, und die Zahl steht dort nicht, um vernünftig zu sein.

Georgij kennt die elf öffentlichen Verträge und, nützlicher, die Meldungen ihrer Kunden. Ein Mann sagt weit mehr über seinen Lieferanten, wenn er sich vor den eigenen Aktionären erklärt.

**Die schwierigen Auslandsgenehmigungen liegen bei den Kims.** Zwei oder drei Routen, politisch heikel, mit Zulassungen, die man nicht kauft, sondern über Jahre erwirbt. Sonst hat sie niemand. Sang-hoon will die Firma nicht wegen der Lastwagen, sondern wegen dieser Zulassungen. Annie braucht sie, weil ihre eigene Ware sonst über Umwege geht, die dreimal so lang sind.

**Georgij weiß das seit seinem vierten Tag im Haus.** Es war nie ausgelassen und ist keine Enthüllung. Ein Mann, der neunzehn Seiten über eine fremde Reederei schreibt und Konsortien bis Singapur zurückverfolgt, weiß in der ersten Woche, womit seine Besitzerin ihr Geld verdient. Er sagt am Tisch selbst, dass es der Grund ist, warum er sie nie gefragt hat, weshalb sie sich für eine Reedereifamilie interessiert.

**Regel dafür:** Grundwissen dieser Art wird dort erwähnt, wo es zum ersten Mal eine Entscheidung erklärt, und nie als Geheimnis behandelt, das aufgedeckt wird.

**Damit ist sie nicht Wohltäterin, sondern abhängig**, und das erklärt alles Weitere: warum sie zahlt, warum sie ein Vetorecht über Routen verlangt und keine Anteile am Fuhrpark, warum sie es leise gelöst haben will, und warum sie es sich nicht aussuchen kann.
...
Das Vetorecht ist also keine Absicherung, sondern eine Engstelle, an der eine ganze Branche hängt. Was sie gewinnt, ist nicht "die Kims gerettet".

**Was das für Georgij bedeutet.** Er hat neunzehn Seiten geschrieben, um einen Mann zu ruinieren, damit ein zweiter Mann eine Firma nicht bekommt, damit die Frau, der er gehört, den Rest ihrer Branche am Hals hat. Er wird das irgendwann zu Ende denken, und dann ist die Frage nicht mehr, ob es funktioniert.

**Offen, und bewusst offen:** Wer regelmäßige Ladungen nach Zeitplan über einen Hafen schickt, in dem der Zoll gerade einen ausgebauten Container gefunden hat, hat ein Interesse daran, dass niemand zu genau hinsieht. Ob Annie davon mehr weiß, als sie sagt, entscheiden wir später. Sie hat den Namen des Garanten und hat gesagt, er ändere, worum sie Georgij bitten müsse. Was sie am Tisch erzählt hat, ist wahr und lohnt sich. Es ist nur nicht alles.

### Die Mechanik: Incheon, die Kims, die Route

**Ab hier Kanon.** Bis Kapitel 9 kennt Georgij davon vier Bruchstücke von einer Terrasse und einen Namen aus Busan.

**Was Sang-hoon getan hat.** Er hat bereits zwei Logistikkonkurrenten aufgekauft. Wie das aussieht, steht in Kapitel 8, ohne dass irgendjemand es benennt: Die Firma mit dem Hof in Pyeongtaek wurde im Februar gekauft, und im **März** hat Choi Dae-ho zwei ihrer Direktoren einzeln nach Busan bestellt, ohne dass einer vom anderen wusste. Die Abendessen kamen also nicht vor dem Verkauf, sondern danach. Was mit dieser Firma gemacht wurde, wurde mit den Männern, die darin sitzen blieben, weitergemacht.

Georgij hat das gehört und kann nichts damit anfangen. Wenn er später erfährt, dass zwei Konkurrenten bereits gekauft wurden, erkennt er das Muster wieder und kann vorhersagen, was den Kims bevorsteht. Als drittes will er die Logistik der Familie Kim. Also hat er in Incheon einen Container in eine Kim-Sendung geschoben, dessen Papiere nicht zum Inhalt passten. Der Zoll hat ihn geöffnet.

**Was darin war.** Der Container war ausgebaut. Kojen, Chemietoilette, Wassertank, Lüftung. **Leer.** Der Ausbau ist der Beweis, nicht die Ladung, und es gibt kein Opfer, auf das jemand zeigen könnte.

Und das ist das Schlimmste daran: Sang-hoon hat sich kein Verbrechen ausgedacht, sondern den Beweis seines eigenen in die Kiste eines Konkurrenten geschoben. Damit sind Auktionshaus, Pipeline, Los elf und Incheon dasselbe Geschäft. Der Fund tritt nie als Szene auf, sondern als Zeile in einer Zollakte, vor der Georgij irgendwann steht.

**Wozu Incheon dient.** Nicht die Fläche, der Status. Ein Lagerhaus im Hafenperimeter mit Zollfreistellung heißt, dass Ware liegen kann, ohne verzollt zu werden, und neu deklariert werden kann, bevor sie weitergeht. Damit kontrolliert man Zeit, und Zeit ist in der Logistik alles. Annies Seite hat die Umwidmung letztes Jahr durchgesetzt: Hana hat gedrängt, Kang hat gezeichnet. Für Sang-hoon ist Incheon deshalb die Stelle, an der man ihn verzögern kann.

**Der Plan von Annie, Georgij und Hana, in drei Teilen.** Keiner funktioniert allein, und das steht in Kapitel 14 ausgeschrieben.
...
**Kein Besitzerwechsel.** Die Firma gehört weiterhin den Kims. Sie brauchen Geld und Rückendeckung, während der Zoll ermittelt und Kunden abspringen, und Annie gibt beides nicht geschenkt: Anteile, Sicherheiten und ein Vetorecht, das im Ernstfall über Routen entscheidet. Der Satz lautet nicht "Ihr wechselt den Besitzer", sondern **"Ihr behaltet den Namen, wir bekommen die Kontrolle."**
...
**Die Arbeitsteilung am Tisch.** Georgij bringt die Beobachtung und sagt dazu, dass sie nichts beweist: siebzehn Aufnahmen, in denen zwei verschiedene Leute mitten im Satz zu ihr hinsehen, ohne es zu merken. Hana bringt die Zahlen, weil sie diese Familie seit zwanzig Jahren kennt. Das ist ihr erster Beitrag, der Leistung ist und nicht Stellung.

**Und daraus folgt Sang-hoons Methode.** Es gibt keine Mehrheit zu kaufen und niemanden, dem man ein Angebot machen könnte. Also kauft er keine Firma, sondern dreht Familienmitglieder einzeln, in Hotels vierhundert Kilometer von deren Arbeitsplatz, so wie in Busan mit den zwei Direktoren. Einen hat er bereits.
...
Deshalb ist das dritte Bein des Plans, die Kunden und Woos Name, nicht das schwächste, sondern das entscheidende: Es kauft Ye-rin keine Zeit, es nimmt der Angst den Anlass.
...
### Hana: was sie einbringt und was sie dafür bekommt

**Sie ist keine Angestellte und kein Werkzeug.** Sie ist eine gleichberechtigte Partei mit eigenem Einsatz, und sie hilft nicht aus Freundschaft.
...
**Warum sie darauf besteht, und sie sagt es selbst:** Sie hat drei Stunden zugesehen, wie diese Runde beschließt, einen Mann mit neunzehn wahren Seiten zu ruinieren. Sie glaubt jedes Wort, das an diesem Tisch gefallen ist, und wäre eine Närrin, als Einzige ohne Papier dazusitzen.

**Der Preis des Papiers**, von Georgij benannt, weil ihn sonst niemand benennt: Der Vertrag existiert. Jemand entwirft ihn, jemand tippt ihn, er liegt in einer Kanzlei, und jeder dieser Menschen ist jemand, den man fragen kann. Er sagt allen, die ihn finden, dass im November zwei Frauen eine Abrede über Incheon hatten, vier Monate bevor irgendetwas geschah. Georgij rät weder zu noch ab und sagt ausdrücklich, dass er nicht weiß, welches Risiko das größere ist. Hana bekommt damit genau das, was sie schützt, in derselben Bewegung, und statt eines Raubtiers nebenan einen Mieter, dessen Eigentümerstruktur sie kennt und dessen Vetorecht bei Annie liegt.
...
**Was sie nicht sagt, sind die Belastungen.** Georgij hat die erste Abteilung, Eigentümer, Daten, Fläche. Die zweite hat er nicht gezogen, und er sagt am Tisch auch warum: Die zweite Abteilung zieht man über jemanden, auf den man sich zu stützen im Begriff ist, und bis vor einer Stunde war er das nicht. Jetzt ist er es. Am Montag also. Sie sagt: "Pull it."

**Die Verifikation, konkret.** Grundbuch, koreanisch **등기부등본**. Öffentlich, online abrufbar, kleine Gebühr, ohne Grund und ohne Nachweis, und die Eigentümerin erfährt nichts davon. Adresse oder Flurnummer genügt.
...
- **Kapitel 28** *A woman in a room can be asked* (v1.6) - Zweite Haelfte des Freitags, ohne Zeitsprung.
...
- **Kapitel 19** *What happens on the Tuesday* (v1.12) - Yeongjong. Die vierzehn Meter, Woo nennt seinen eigenen Preis und bekommt ihn unterschrieben, der leere Tarif, "Can you fill it?", die drei Daten und ein Mittwoch im September, und was er sich selbst dabei ausrechnet.
...
- **Kapitel 15** *Four thousand two hundred* (v2.9) - Das Essen zu dritt, Ye-rin, das Vetorecht, der Mietvorvertrag, die viertausendzweihundert.
...
- **Kapitel 13** *The man with the open hand* (v2.8) - Das Ja ohne Bedingung, der Mietwagen und das vierte Datum, das Essen mit Woo.
...
- **Kapitel 6** *Withdrawn or sold* (v1.8) - Der Katalog ohne den Jungen, die drei aus dem Keller, der Kragen, Jang vor dem Abend, Mrs Seo, die Fernbedienung in die Clutch.
...
- **Band 2, Kapitel 1** *Nothing to sign with* (v1.6) - **Tag 150, Mo 2. Maerz, der Tag nach dem Schluss von Band 1. Ein Tag, drei Szenen.**
...
- **Band 2, Kapitel 3** *We haven't met* (v1.2) - **Tag 155, Sa 7. Maerz. Drei Tage Aktenarbeit, rueckblickend erzaehlt, dann der Abend.**
...
- **Band 2, Kapitel 18** *The face on it* (v1.2) - **Tag 206, Mo 27. April, abends. Eine Szene, das kleine Zimmer, am selben Tag wie Kapitel 17.**
...
- **Band 2, Kapitel 31** *Nobody hides flowers* (v1.1) - **Tag 239, Sa 30. Mai. Zwei Szenen, der Schreibtisch vor sieben und ein Blumengeschaeft in Hyoja-dong.**
...
- **Band 2, Kapitel 34** *The best company in the room* (v1.2) - **Tag 244, Do 4. Juni. Nacht bis halb sieben morgens, der Schreibtisch.**
...
- **Band 2, Kapitel 37** *A piece of paper somewhere in the world* (v2.0) - **Tag 255, Mo 15. Juni. Der Schreibtisch, der Post, das kleine Zimmer.**
...
## Bloecke, die geschrieben sind

**A bis C sind im Text.** Was hier steht, ist Herkunftsnotiz und kein Vorhaben.
Es steht noch da, damit niemand dieselbe Idee ein zweites Mal fuer neu haelt und
damit die Korrekturen nachvollziehbar bleiben.

Kanon ist ausschliesslich der Text. Wo dieser Plan ihm widersprach, wurde der
Plan geaendert.

### Blockübersicht gegen den Kanon

| Block | Stoff | Stand |
|---|---|---|
| A | Das Haus bei Nacht | Kapitel 3 |
| B | Protokoll, die Wochen bis zur Gala | Kapitel 4, 5, 6 |
...
Inhalt aus dem Rohmaterial A6 und A7, in unserer Fassung um zwei Dinge erweitert, die die Vorlage nicht hat:

- **Das Personal.** Er lernt in dieser Nacht drei Leute kennen und benotet jeden sofort, weil Kompetenz seine einzige Währung ist. Die Haushälterin ist besser als alle im Wagen zusammen. Das Mädchen hat Angst und redet zu viel. **[KORRIGIERT]** Der Junge am Seiteneingang macht **drei** Dinge richtig, und Georgij zählt ihm alle drei auf: er sieht auf die Hände, bevor er ins Gesicht sieht, er behält die Tür zwischen sich und dem Fremden, bis er entschieden hat, was da steht, und er leiht sich keine Autorität aus, die er nicht hat. Das dritte ist das entscheidende und der Vorgänger hat es in zwei Jahren nie gelernt.
- **Die Inspektion.** Er schläft nicht, sondern geht das Haus ab: Glas, Rahmen, Garagentür, Säulen, Kamerawinkel, die Ostseite mit den Rosen und der Mauer.

Sie stellt ihn im Flur, an der Kreuzung, also in einer der toten Zonen. Sie zählt seine Route auf, bevor er etwas sagt. Er bringt die Beschwerde über die Kamerawinkel vor, und sie hört sie sich an.

**Annie erteilt in dieser Nacht keinen einzigen Befehl.** Das ist Absicht und ist so geblieben. Aufträge kommen erst in Block B.

**[KORRIGIERT] Das Kapitel endet nicht auf "There are no exits, Georgij."** Der Satz fällt, aber er ist die vorletzte Bewegung. Er antwortet "Four, Mistress.", zählt sie auf, gibt ihr danach das Kompliment über die Winkel, und das Kapitel endet damit, dass er den Messingschlüssel in seiner Tür stecken lässt, wo er ist. Wer die Zeile später zitiert, muss wissen, dass sie beantwortet wurde.

**Offener Faden, der hier gesetzt wird:** Die Haushälterin hat auf der Auffahrt telefoniert. Kein Krankenwagen, kein Notruf, unter einer Minute, und sie hat keine Adresse genannt. Georgij fragt beide danach. Keine der beiden antwortet.

**Anschluss beachten:** Die Fernbedienung liegt auf dem Steinvorsprung neben der Schlüsselschale an der Haustür. Er kommt in dieser Nacht mehrfach daran vorbei. Das braucht keinen Kommentar.

### [KORRIGIERT] Die östlichen Rosen sind keine tote Zone

Der Plan hat bisher behauptet, die erste Nacht setze die tote Zone hinter den östlichen Rosenbüschen für Block I. **Das ist durch Kapitel 4 und 5 widerlegt und muss weg.**

Was tatsächlich dort steht:

- In der ersten Nacht sieht Georgij am Fenster des ersten Stocks zwanzig Meter flachen Rasen, die Mauer, die alten Rosen davor, und dass die Kamera an dieser Hausecke die Auffahrt ansieht. Er hält die Stelle deshalb für offen.
- **Am zweiten Abend findet er Kamera vierundzwanzig.** Osttraufe, sieht nicht das Haus an, sondern über den Rasen auf genau diese Rosen. Sie steht auf keiner Wand und in keinem Plan und existiert nur im Archiv.
- **Am vierten Tag zeigt er sie Jang.** Beide zusätzlichen Kameras, Türsturz und Osttraufe, auf dessen Aufforderung "Show me now."
- **Tae-min macht montags und donnerstags den Ostrasen.** Zwei Tage die Woche steht ein Mann vor den Rosen.

Für Block I heißt das: Die Ostmauer ist die am besten beobachtete Stelle der Umfassung, und Georgij weiß das seit Tag zwei, und Jang seit Tag vier. Siehe dort.

### Block B - Protokoll **[GESCHRIEBEN, Kapitel 4, 5, 6]**

Die Zeit zwischen Kauf und Gala.

- **[KORRIGIERT] Jang ist nicht der Ersatz für den Wachmann.** Er ist Interimschef der Sicherheit und war ohnehin unterwegs, weil Mr Noh nach zweiundzwanzig Jahren Ende des Monats geht und seit März Resturlaub abbaut. Georgij erfährt das erst von Jang selbst und beansprucht den Zufall ausdrücklich nicht für sich: "That part is luck and I won't claim it." Der Rest stimmt. Jang hat die Geschichte gehört, bevor er ankam, genau wie Georgij es geplant hat, er ist besser, und Georgij behandelt ihn mit ehrlichem Respekt. Was durchs Haus geht, ist bis zum Mittagessen nicht das Auge, sondern dass Georgij ihn Mr Jang nennt.
- Das Halsband bleibt. **Die Fernbedienung verschwindet an Tag neun vom Steinvorsprung**, am Tag des Schneiders. Georgij merkt es an dem leeren Fleck neben der Schale und sieht nicht zur Kameraleiste hoch, weil ein Bild von ihm beim Bemerken eine eigene Datei wäre. Wo sie danach liegt, sagt niemand. Erst in Kapitel 11 hört er nach der Gala eine Schublade.
- Georgij bekommt keine Aufgaben. **[ÜBERHOLT]** Der Plan sah "Aufgaben, bei denen ihn niemand sieht" vor. Im Text sagt sie stattdessen: drei Wochen, Grand Hotel, als Gast, dazwischen gehört seine Zeit ihm, solange er nachts im Haus ist. Der Auftrag kommt ohne Ziel, und was er sucht, ist sein Problem.
- Der Schneider. Die Kragenfrage wird gelöst, ohne dass jemand ausspricht, worum es geht. Der einzige persönliche Satz des alten Mannes ist der über das Kinn.
...
**Ein Abend, sechs Kapitel.**

**[KORRIGIERT] Kapitel 6 ist nicht der Tag davor.** Es ist der Tag der Gala selbst, Tag 22, Samstag der 25. Oktober, von neun Uhr morgens bis zur Abfahrt um sieben. Der Katalog kommt an diesem Morgen, der Anzug um zwei, Jang um sechs, Mrs Seo um halb sieben, Annie neun Minuten vor sieben. Der ganze Abend liegt an einem einzigen Tag, und die Nacht danach zählt erzählerisch dazu.

**Festgelegt und eingelöst:** Georgij fährt mit ihr im selben Wagen und geht als ihr Begleiter hinein. Erste Viertelstunde am Ellenbogen, danach schneidet sie ihn los, ohne Signal, und sucht ihn, wenn sie ihn will.

**Keine Lose und kein Katalog auf der Gala.** Es ist eine legitime Wohltätigkeitsveranstaltung. **[KORRIGIERT]** Es gibt keine stillen Tische. Es gibt neun Lose zwischen Hauptgang und Reden, Karten auf den Tischen, Nummern auf Paddeln, einen Rundfunksprecher am Pult und einen hölzernen Hammer etwa so lang wie ein Löffel. Los neun ist Chef Bang Seung-min, Zuschlag zweiundsechzig Millionen, und Georgijs Rechnung dazu lautet drei einhalb.

**Drei der neunzehn aus dem Keller sind unter den achthundert.** Der Vierte-Reihe-Herr, die Dame an der Säule und einer der sieben vorn. Annie sagt, es sei geregelt, und was das heißt, sagt sie nicht. Der Text zeigt nur, dass es gehalten hat: Mrs Sunwoo reicht ihm unter achthundert Lichtern die Hand und sagt "We haven't met."

### Block C - Die Gala **[GESCHRIEBEN, Kapitel 7 bis 11]**

Rohmaterial Teil B. Grand Hotel, roter Teppich, Ballsaal. Das ist der Abend, den Annie in der Auffahrt angekündigt hat: die Hälfte, bei der die Hände sauber bleiben.

Der Kragen sitzt. Die Fernbedienung ist in ihrer Clutch, und beide wissen es den ganzen Abend, und keiner von beiden sagt in sieben Stunden ein Wort darüber.
...
**[KORRIGIERT] Es gibt keine Visitenkarte.** Nirgends, an keiner Stelle des Abends. Sang-hoon sagt "After the fifteenth. My office will find you, and don't give me a number, because you were not going to." Georgij bestätigt, dass er keine geben wollte. Der Plan hat die Karte an vier Stellen geführt: im Gala-Ablauf, hier in Block C, in Block E und in Block F. Alle vier sind gestrichen. Was auf Annies Schreibtisch landen kann, ist ein Datum und kein Gegenstand.

**[KORRIGIERT] Sang-hoon steht nicht an der Bar** und das Wort "ewig" fällt nicht. Er sitzt an Tisch zwei, allein, seitlich, um zehn nach elf, zu einer Zeit, zu der in dem Raum fast niemand sitzt, mit einem Arm über der Lehne des Nachbarstuhls, und sieht dem Saal zu wie einem Feld. Er sieht Georgij beim Antworten auf die Hände und nicht ins Gesicht.

**[KORRIGIERT] Die Allianz wird auf der Gala nicht geschlossen.** Das Gegenteil steht im Text: Annie und Hana wechseln in fünf Stunden kein einziges Wort, in einem Gebäude, in dem beide arbeiten, und das ist eine Absprache und kein Versäumnis. Georgij sieht beide Enden eines Blickwechsels von unter zwei Sekunden. Zusammengesetzt wird es erst neunzehn Tage später am Esstisch in Kapitel 15, und dass Hana überhaupt die Auffahrt hochkommt, ist in Kapitel 14 eine eigene Kostenrechnung.

**[KORRIGIERT] Georgijs Legende.** In der Vorlage erzählt er von Büchern, die er mit fünf gelesen hat, und Min-ho nennt ihn direkt einen pathologischen Lügner. Beides entfällt. Min-ho spricht Georgij am ganzen Abend nicht an, er sagt auf der Terrasse fast nichts und stellt zwei kurze Fragen über andere Leute. Die Ausbildungsfrage kommt bei Minute zwölf von Mr Hong, und Georgijs Antwort lautet: privat, hier und da, elf verschiedene Häuser, unterrichtet von wem gerade im Haus war, gelesen wurde, was man ihm gab, und das waren meistens Jahresberichte. Jedes Wort wahr, keines je zurückzunehmen, und Hong lacht, hört auf zu lachen und sagt "You advise her."

**Was die Legende an derselben Stelle einbringt:** die schmeichelhafteste Frage der Welt, "Who should I be careful of?", drei Namen, und Choi Dae-ho an dritter Stelle. Und die Erkenntnis, dass die vierhundertdreißig Namen keine Anwesenheitsliste sind, sondern eine Liste derer, die beim Hineingehen eine Spur hinterlassen haben.
...
- **Der vierte Wagen.** Jang findet einen Mietwagen, der von acht bis elf vierzig in der Rampe steht, niemanden abholt, niemanden im Fond hat. Georgij zieht über einen Facility-Supervisor die Kontonummer und vier Blockbuchungen in vierzehn Monaten. Drei Daten sagen ihm nichts. Das vierte ist die Nacht, in der er gekauft wurde. Jemand wartet vor Gebäuden und geht nie hinein.
- **Das Essen mit Woo, Tag 28.** Die Frage, was mit dem Terminal geschieht, wenn er an einem Dienstag stirbt. Ein Mann um die fünfzig, Hongkong-Akzent im Englischen, keiner im Koreanischen, keine Karte. Und Woos Satz über den Mann mit der offenen Hand in etwa sechs Wochen. Georgij weiß beim Hinausgehen, welche vier Minuten dieses Abends er später benutzen wird, um Woo um etwas Teures zu bitten.
- **Die Gesichter, Tag 31.** Zweitausendeinhundertsechs Aufnahmen, gekauft wie ein Berater Bilder kauft. Damit schließt sich die Lücke zwischen Namen und Gesichtern. Kim Ye-rin und Kim Do-yun bekommen ihre Namen, und Georgij stellt fest, dass er sich in Do-yuns Charakter geirrt hat, aus vier Sekunden Beobachtung, und dass er es nur durch die Kamera eines Fremden erfährt.
- **Hanseong, Tag 33 und 34.** Aus der falschen Schublade gefunden, beim Kartieren der Routen. Acht Seiten bei ihr, nicht neunzehn, weil neunzehn fertige Seiten eine Unterschrift verlangen. Der Plan in drei Teilen: Geld, Zeit, Kunden. Und das erste Lächeln, das er ihr gibt.
- **Das Essen zu dritt, Tag 41.** Ye-rins 1,4 Prozent, Hanas sechzehntausend Quadratmeter, der aufschiebend bedingte Mietvertrag, die zweite Hälfte des Vetorechts und die vier Konkurrenten auf denselben Fahrwassern, und die viertausendzweihundert.
...
1. **Annie unterschreibt den Mietvorvertrag**, vor Hana, ohne dass sie zweimal fragen muss. Zugesagt in Kapitel 15 mit "I will sign it on Monday, in front of you." **Steht weiterhin aus** und gehört am ehesten in die Heimfahrt oder in das Kapitel danach.
2. **Georgij zieht die zweite Abteilung des Grundbuchauszugs** über Hanas Flächen. Belastungen, Höhe, Gläubiger. Zugesagt in Kapitel 15, und Hana hat "Pull it" gesagt. **Erledigt in Kapitel 16 v1.4**, an der Stelle, an der Sang-hoon nach Hanas Besitz in Incheon fragt: Er hat sie am Vortag gezogen, und was darin stand, macht das Schweigen teurer als fünf Tage vorher. Der Inhalt wird nicht genannt, nur dass es ihn gibt.

---

---

## Bloecke, die noch kommen

**Keine Kapitel.** Die Buchstaben sagen nur, in welcher Reihenfolge das Material
im Rohverlauf auftauchte. Kein Kanon, sondern Stoff.

**Reihenfolge:** F, G, H, I, J bauen aufeinander auf. D ist ueberholt und steht
nur noch da, weil ein Teil davon unbenutzt ist. E ist halb geschrieben.

Vor jedem dieser Bloecke wird der Inhalt besprochen, nicht sofort geschrieben.

### Block D - Frühstück **[ÜBERHOLT]**

Rohmaterial A-Ende und Szene 2. Hana wartet, Georgij kommt zu spät, legt den Hanseong-Bericht auf den Tisch.

**Dieser Block ist durch Kapitel 14 und 15 ersetzt und darf nicht mehr als Vorhaben gelesen werden.** Was daraus geworden ist:

- Der Hanseong-Bericht liegt zweimal auf einem Tisch, und keines der beiden Male vor Hana. Acht Seiten bei Annie an Tag 34, neunzehn Seiten bei Sang-hoon an Tag 46.
- Hana kommt nicht zum Frühstück, sondern abends um sieben zum Essen zu dritt, in das kleine Zimmer neben dem langen. Georgij kommt nicht zu spät.
- Sang-hoons eine Eigenschaft, dass er nach dem ersten Biss nicht loslassen kann, bleibt und ist die ganze Mechanik von Hanseong.

**Was aus dem Block noch unbenutzt ist:** Die Formel von den Korrupten als Skalpell und den Loyalisten als Schutzschild. Sie ist bisher in keinem Kapitel gefallen. Wenn sie kommt, gehört sie Hana, und sie gehört an eine Stelle, an der über den Vorstand von Hanseong oder über die sechs Kim-Anteilseigner entschieden wird.

**Gestrichen bleibt:** die Sprüche über Haie, die Blut riechen, und über Männer, die Glas essen und Süßigkeiten erwarten.

### Block E - Kang Ji-hoon **[TEILS GESCHRIEBEN, Kapitel 12]**

**Zwei Sachen aus der Vorlage, die nicht wiederkommen, und beide haben gehalten.**

Erstens: Es gibt **keine unbekannte Nummer**, die Georgij per SMS die Gästeliste oder Kangs Abendessen zuspielt. Ein Deus ex Machina entwertet genau die Fähigkeit, für die Annie zweihundertzwanzig Millionen bezahlt hat.

Zweitens: Kang wirkt **nicht hellseherisch**. Der Grund für den Anruf ist im Text gelegt: Kang stand in Kapitel 9 innen an den Terrassentüren an der einzigen Stelle des Gebäudes, an der man Saal und Terrasse zugleich hört, hat gehört, wie laut Hana über Incheon war, und gesehen, an wessen Arm Georgij stand. Danach hat Georgij ihn in Kapitel 10 selbst angesprochen und um Orientierung bei allem gebeten, was mit Flächen und Genehmigungen zu tun hat. Kang liest das nicht als Kompliment, sondern als Lücke, und ruft an.

**Der Anruf ist geschrieben, Tag 25.** Kang fragt nach der Umwidmung am östlichen Abschnitt und will die Position ihrer Seite. Georgij lügt nicht, sagt "I have no position", und begründet, dass er lieber nutzlos als erfinderisch ist. Kang nennt das eine bessere Antwort als die erwartete und gibt ihm zum Schluss einen echten Hinweis auf die Novelle von 2019.

**Was der Anruf ihn tatsächlich kostet**, und das ist die eigentliche Pointe: Er hat Kang nicht die Position gegeben, weil er sie nicht hat. Gegeben hat er, zweimal, in eigener Stimme, dass Annies Berater zu Incheon nicht gebrieft ist. Das trägt Kang weiter, es hat zwei Lesarten, und Georgij kann keine davon korrigieren, ohne zu erfinden. Er nimmt außerdem von der ersten Sekunde an, dass mitgeschnitten wird.

**Und Sang-hoon hatte ihn längst prüfen lassen.** In Kapitel 16 kommt der Griff bei Minute zwölf zurück: Hong, und ein Mann von Land und Infrastruktur, der mit Sang-hoons Leuten über anderes spricht. Zwei Meldungen in vierzehn Tagen nach zwei Benutzungen an einem Abend.

**[OFFEN] Das Abendessen mit Kang.** Noch nicht geschrieben, und zwei Dinge daran sind jetzt anders.

- **[KORRIGIERT] Hanseong gehört nicht in dieses Essen.** Der alte Plan ließ Georgij den Bericht als Gegenleistung an Kang liefern. Das geht nicht mehr und ging nie: Hanseong ist der Köder für Sang-hoon und nur für ihn, er liegt seit Tag 46 auf dessen Schreibtisch, und ein zweiter Empfänger macht aus einer Vergiftung eine Verteilung. Was Georgij Kang zu geben hat, muss aus dem Ministeriumsstoff kommen und nicht aus dem Schiffsstoff.
- **[KORRIGIERT] Die schwarze Karte, Donnerstag, Shilla, neun Uhr** ist ein unbelegter Vorschlag aus der Vorlage. Es gibt im Kanon keine Karte, keine Shilla-Versammlung und keinen Donnerstagstermin dieser Art. Wenn wir die Versammlung wollen, muss sie neu begründet werden, und sie darf nicht über einen Gegenstand laufen, den jemand überreicht.
...
**[KORRIGIERT] Er legt keine Karte auf ihren Schreibtisch**, weil es keine gibt. Was er hinlegt, ist das Ergebnis: ein Datum, ein Ort, und was der andere Mann dafür genommen hat. Die Szene braucht den Gegenstand nicht, sie braucht die Verbeugung.

Ihr Satz "Du wirst ziemlich teuer" bleibt. Ihr Satz "Verwechseln Sie Nützlichkeit nicht mit Loyalität. Ein Werkzeug ist nützlich, bis es kaputt geht" bleibt ebenfalls, und er ist die Ladung für den Bruch.

Georgijs Ritual: "War ich nützlich?" Sie bestätigt es. Dann sagt er ihren Namen, und weil sie in ihrem eigenen Haus sind, ist das ein Regelbruch, den beide hören.

**[KORRIGIERT] Es ist der zweite Regelbruch, nicht der erste.** Der erste ist in Kapitel 9 gefallen, in die falsche Richtung: "Mistress" zu Hana, auf der Fläche, kurz vor elf, nach zehn Minuten Freundlichkeit. Er hat ihn in Kapitel 11 von sich aus gemeldet, ohne dass jemand gefragt hätte, und ihre ganze Antwort war "Thank you for telling me." Wenn er hier ihren Namen benutzt, hat der Leser also bereits gesehen, was ein Bruch in dieser Sache kostet, und er hat gesehen, dass Georgij sie meldet. Dass er diesen hier **nicht** meldet, weil er ihn absichtlich begeht, ist der eigentliche Vorgang der Szene.

**Anschluss:** Die Fernbedienung liegt in der Schublade dieses Schreibtischs. **[KORRIGIERT]** Der alte Plan ließ offen, ob er das hier merkt. Kapitel 11 hat die Hälfte davon bereits gesetzt: In der Nacht nach der Gala hört er im Flur die Studiotür und ein paar Sekunden später eine Schublade. Er hat also seit Tag 22 einen Verdacht und keine Bestätigung, und die Szene hier kann ihm die Bestätigung geben oder sie ihm weiter verweigern. Beides trägt, aber die Ausgangslage ist nicht mehr Unwissen.
...
> Wir hatten eine Vereinbarung. Quid pro quo. Du behandelst mich gut, ich bin Dein nützlicher Schatten. Die hast Du heute gebrochen, Herrin.

**[KORRIGIERT] Die Vorbereitung des Satzes ist abgeschlossen. Ab jetzt nicht mehr benutzen.**

Der alte Plan verlangte zwischen Kapitel 2 und dem Bruch noch zwei bis drei beiläufige Nennungen. Es sind vier geworden, alle beiläufig, drei davon aus ihrem Mund:

| Stelle | Wer | Wie |
|---|---|---|
| Kapitel 3 | Georgij | leicht hingesagt, wie ein Wochentag, sie hebt es nicht auf |
| Kapitel 4 | Annie | "wie man eine Lieferung quittiert", dann liest sie weiter |
...
**Das macht den Block nicht kaputt, es macht ihn besser**, und zwar genau in der Richtung, in die er ohnehin schon zeigte. Das Motiv war ohnehin nicht Flucht, sondern Demonstration. Jetzt ist es eine Demonstration vor einem bestimmten Publikum:

- Die Kamera läuft auf keiner Wand und in keinem Plan und existiert nur im Archiv, und das Archiv sieht seit vier Jahren niemand an außer ihr.
- Er geht also über die einzige Mauerstelle des Grundstücks, von der er sicher weiß, dass **sie** es sehen wird und sonst niemand.
- Er geht nicht heimlich hinaus. Er geht dorthin, wo er gesehen wird, von der einzigen Person, die hinsieht.

Damit steht "Sie findet ihn, weil er nicht schwer zu finden ist" nicht mehr als Behauptung da, sondern als Folge. Er hat ihr den Weg gezeigt, bevor er ihn genommen hat.
...
- "Ich wollte sehen, ob du zerbrechen würdest."
- Sein "Behandle mich wie einen Menschen. Respektvoll." zum zweiten Mal, ohne Bitterkeit.
- Ihre Analyse, warum er geblieben ist: nicht weil er Sklave ist, sondern weil er etwas aufbaut.
- Sein Konter, dass sie ihren eigenen Wert unterschätzt.
- Ihr erstes echtes Lachen.

**Was ich streichen würde:** "Ich weiß nicht, wie ich mit jemandem umgehen soll, der nicht käuflich ist." Zu erklärend. Die Szene zeigt es bereits.

**Was ich ergänzen würde:** Sie hat die Fernbedienung dabei, aus der Schreibtischschublade. Sie legt sie zwischen sie auf den Beton, so wie sie sie in der ersten Nacht neben die Schlüsselschale gelegt hat. Kein Kommentar. Damit schließt sich der Kreis, und das Halsband bleibt trotzdem an seinem Hals.
...
|---|---|---|---|---|
| Annie | 680 | 74 (b1ch01-b2ch55) | 1 | 74 |
...
| 9 | b2ch09:42 | "It was the right trade," said Annie. "It is still a leak. Those two are going to be tru.. |
| 9 | b2ch09:60 | Annie went round the desk and sat down, which she does perhaps twice a month. |
| 9 | b2ch09:84 | Annie did not answer immediately, and it was not reluctance. |
| 9 | b2ch09:92 | "A deletion," said Annie. |
| 9 | b2ch09:114 | Annie put both hands on the arms of the chair. |
| 9 | b2ch09:132 | Annie did not move at all for a while. |
| 9 | b2ch09:150 | Annie stood up and went to the window and did not draw the curtain. |
| 9 | b2ch09:164 | Annie did not turn round. |
| 9 | b2ch09:188 | Annie turned round. |
| 9 | b2ch09:210 | Annie came back to the desk. |
...
| 1 | b2ch11:48 | "She has done the work," said Annie. |
| 1 | b2ch11:58 | Annie read it once more. |
| 1 | b2ch11:82 | "Then say the price before you spend it," said Annie, "because that is the arrangement a.. |
| 1 | b2ch11:94 | "And what do you say it buys," said Annie. |
| 1 | b2ch11:106 | Annie put the letter down. |
| 1 | b2ch11:120 | Annie did not answer that. |
| 1 | b2ch11:138 | "It is not a condition." Annie came back to the desk. "It is a thing I am telling you so.. |
| 1 | b2ch11:160 | Annie looked at him. |
| 1 | b2ch11:262 | A person who has been told the truth about somebody stops going and looking for it. He h.. |
...
| 4 | b2ch14:152 | What he did instead was write four words in the notebook in the car, and they are the se.. |
...
| 11 | b2ch20:160 | "I am not going to be your conscience," said Annie. "Not because I do not want the job. .. |
| 11 | b2ch20:196 | Annie did not answer that for a moment. |
| 11 | b2ch20:214 | "What happens to her now," said Annie. |
...
| 40 | b2ch30:88 | Annie did not turn round. |
| 40 | b2ch30:112 | Annie came back and sat down at the desk after all, which she had not been going to do. |
| 40 | b2ch30:140 | "I am aware of what you paid," said Annie. "I have been aware of it since the second sen.. |
| 40 | b2ch30:176 | Annie looked at him for a long moment. |
| 40 | b2ch30:210 | Annie stood in the middle of her own room. |
| 40 | b2ch30:222 | "I am going to employ her," said Annie. |
| 40 | b2ch30:238 | "She will not take it the way it was offered to her in April, and she was right not to.".. |
| 40 | b2ch30:242 | "That is in the commercial register and anybody in this country may go and read it," sai.. |
| 40 | b2ch30:248 | "It is the second enormous thing she will have been handed today, and she is going to no.. |
| 40 | b2ch30:260 | Annie held his eye and took none of the weight off it. |
| 40 | b2ch30:286 | "There is one more thing and then you are finished for the day," said Annie. |
| 40 | b2ch30:330 | "Sit on the floor," said Annie. "I have four hours of this and you are going to be quiet.. |
| 40 | b2ch30:348 | At about half past nine Annie put her hand down into his hair without looking, which she.. |
...
| 51 | b2ch36:42 | "A room, a wedding that did not happen, and a man who left the country for four years af.. |
| 51 | b2ch36:54 | Annie opened the folder for the first time since he had come in and turned it round so i.. |
...
| 51 | b2ch36:445 | *Annie, thirty-one times, and every one of them believes it was a woman being polite abo.. |
...
| 61 | b2ch39:240 | "Before you were anywhere near this," said Annie, "which means it was not you he suspect.. |
| 61 | b2ch39:252 | "Sang-hoon gave you the name for nothing, in a shed, of his own accord," said Annie. "A .. |
| 61 | b2ch39:266 | "I do not know that yet, and neither do you," said Annie. "But it is the first time eith.. |
| 61 | b2ch39:290 | Annie did not say anything, which is how she asks him to keep going. |
| 61 | b2ch39:306 | Annie came round the desk and stood where she could see his face. |
| 61 | b2ch39:330 | "Then you have found the fastest road and it is also the loudest," said Annie. |
| 61 | b2ch39:346 | Annie let that sit exactly as long as it deserved and no longer. |
| 61 | b2ch39:366 | "Six," said Annie. "And you will want it to be seven in about ten days." |
...
| 3 | b2ch40:124 | "The third one is not mine to say in this room," said Jang. He waited, and Annie moved o.. |
...
| 5 | b2ch43:270 | Annie was in the small room when he came back, going through a delivery ledger of her ow.. |
| 5 | b2ch43:282 | "Then stop looking at tables." Annie set her pen down. "A man who wants no record does n.. |
| 5 | b2ch43:298 | "I grew up watching my own father do business on a golf course twice a month and call it.. |
| 5 | b2ch43:318 | K would not be like that, and he understood why the moment Annie said it aloud. A golf c.. |
| 8 | b2ch44:97 | Annie was at the desk with the ledger open and did not close it. |
| 8 | b2ch44:117 | Annie put the pen down across the ledger. |
| 8 | b2ch44:141 | Annie was quiet for a moment, and when she spoke it was not about the machine. |
| 8 | b2ch44:169 | Annie looked at him for what felt like a long time and was probably three seconds. |
| 8 | b2ch44:267 | He wrote both options down with the reason under each, and the second one at the bottom,.. |
...
| 2 | b2ch48:230 | Annie was in the small room when he got back, at his desk rather than at hers, with the .. |
| 2 | b2ch48:246 | "I know it was not on purpose. You have not done anything on purpose since Saturday morn.. |
| 2 | b2ch48:270 | Annie put one hand flat on the open notebook. |
| 2 | b2ch48:294 | Annie did not tell him he was right, which he noticed, and which he was grateful for in .. |
| 2 | b2ch48:330 | Annie waited. |
| 2 | b2ch48:342 | "Then that is as far as it goes tonight," said Annie. |
| 4 | b2ch49:10 | Annie had not told him to go and had not told him not to, and had said one sentence abou.. |
| 4 | b2ch49:270 | He told Annie in the small room before dinner, in order, and it took under three minutes. |
| 4 | b2ch49:286 | "Then you were right on Saturday and now you have got it from a second room." Annie did .. |
| 4 | b2ch49:314 | Annie let that stand in the room for a moment. |
| 3 | b2ch51:44 | There were six kitchens on the list he had made on a Sunday evening in June. He went to .. |
| 3 | b2ch51:66 | Annie read the card without picking it up, twice, and put one finger on the fourth line. |
| 3 | b2ch51:94 | Annie stood back from the desk. |
| 3 | b2ch51:114 | Annie let that stand. |
...
- `b2ch36:445` (Tag 51) - one, thirty-one
...
- `b2ch43:298` (Tag 5) - eighteen, four, one
- `b2ch43:318` (Tag 5) - four
- `b2ch44:169` (Tag 8) - three
...
- `b2ch48:270` (Tag 2) - one
- `b2ch49:10` (Tag 4) - one
- `b2ch49:270` (Tag 4) - three
- `b2ch49:286` (Tag 4) - eleven
...
| 38 | b2ch27:204 | "I did not want you to find out that it is also a description of somebody who is not," s.. |
| 45 | b2ch33:236 | "There is also Sang-hoon's four," she said. "He gave you a task in a shed last week and .. |
...
| 47 | b2ch35:18 | "I have had nine days of thinking about a sentence I said to you in a shed," said Sang-h.. |
| 47 | b2ch35:28 | Sang-hoon already has the name. Saying it again on an open line, next to flowers and a s.. |
...
| 51 | b2ch36:120 | "You are telling me you have failed," said Sang-hoon, and did not say it unkindly. |
| 51 | b2ch36:140 | "Annie has not let you," said Sang-hoon. |
| 51 | b2ch36:146 | Sang-hoon sat back. |
| 51 | b2ch36:158 | Something in Sang-hoon's face eased by a fraction that a stranger would not have caught. |
| 51 | b2ch36:170 | Sang-hoon considered that for what felt like a long time and was probably eleven seconds. |
| 51 | b2ch36:182 | "There was no arrangement," said Sang-hoon. "There was a man who told me he needed four .. |
| 51 | b2ch36:194 | "I suspected before you told me. There is a difference, and you have been the one drawin.. |
| 51 | b2ch36:206 | "Nothing, yet. I want to know who owns it under the four owners." Sang-hoon looked at hi.. |
| 51 | b2ch36:218 | Sang-hoon looked at the window for a moment before he answered, and Georgij had the sens.. |
...
| 61 | b2ch39:132 | The man he is looking for does not eat in front of anybody he is working on. Whoever sat.. |
| 61 | b2ch39:160 | He telephoned Sang-hoon that evening, from the house, on a line Annie had already told h.. |
| 61 | b2ch39:168 | Sang-hoon did not say anything for a moment. |
| 61 | b2ch39:180 | "That is not caution," said Sang-hoon. "That is a man who does this often enough to have.. |
| 61 | b2ch39:188 | "Good," said Sang-hoon. "I did not want it to be him either, and I notice that neither d.. |
| 61 | b2ch39:248 | "Sang-hoon," said Georgij. |
| 61 | b2ch39:252 | "Sang-hoon gave you the name for nothing, in a shed, of his own accord," said Annie. "A .. |
| 61 | b2ch39:258 | He thought about the shed, and the way Sang-hoon had said the name flatly, without being.. |
...
| 2 | b2ch42:62 | Sang-hoon sat with that. |
| 2 | b2ch42:90 | Sang-hoon did not answer straight away, and Georgij let him have the time, because a man.. |
| 2 | b2ch42:94 | "You are asking a man who runs eleven thousand people to hold a name in his mouth and do.. |
| 2 | b2ch42:118 | Sang-hoon almost smiled at that and did not quite. |
| 2 | b2ch42:130 | "Four," said Sang-hoon. |
| 2 | b2ch42:142 | "That is not the answer," said Sang-hoon. |
| 2 | b2ch42:158 | Sang-hoon looked past him at nothing for a while. |
| 2 | b2ch42:178 | "He was at that table," said Sang-hoon. "He ate, and he complimented something, and he l.. |
| 2 | b2ch42:196 | "You have gone somewhere," said Sang-hoon. |
| 2 | b2ch42:212 | Sang-hoon took that better than Georgij had expected, and worse than he let it show. |
| 2 | b2ch42:228 | "I have had a week longer because a registry does not care how impatient either of us is.. |
| 2 | b2ch42:236 | "Four owners is not four names," said Sang-hoon. "It is four holding companies, each one.. |
| 2 | b2ch42:244 | "The fourth is a trust, and a trust is not required to say who benefits from it, which i.. |
| 2 | b2ch42:256 | "The trust was formed in October, eleven years ago," said Sang-hoon. "I do not know what.. |
| 2 | b2ch42:260 | Georgij did not answer that directly, and Sang-hoon did not press him on it, which was i.. |
...
| 2 | b2ch42:292 | "Sixty-three, according to the bar association's own photograph, which is eleven years o.. |
| 2 | b2ch42:300 | "Because a man who does this for money can be bought back out of it," said Sang-hoon. "A.. |
| 2 | b2ch42:320 | Sang-hoon looked at him for a long moment before he answered. |
...
| 2 | b2ch42:412 | "Then say which one you are actually able to answer today." Sang-hoon set his cup down. .. |
| 2 | b2ch42:424 | "That is an honest answer, and it is also the first time you have given me one that frig.. |
| 2 | b2ch42:442 | He wrote them down exactly as Sang-hoon had given them, without deciding which one matte.. |
...
| 5 | b2ch43:190 | They met at the same table as Tuesday, because Sang-hoon had said on the telephone that .. |
| 5 | b2ch43:202 | Sang-hoon's face did not move, and that itself was the answer, because his face had move.. |
| 5 | b2ch43:230 | Sang-hoon set the cup down without having drunk from it once. |
| 5 | b2ch43:234 | "That was the dinner where Choi asked me to move a shipment through my own name with no .. |
| 5 | b2ch43:254 | "Then it happened somewhere I have not yet thought to be ashamed of." Sang-hoon almost l.. |
| 5 | b2ch43:262 | "Find where a man decides something when there is no table and no bill to prove he was e.. |
| 5 | b2ch43:322 | He did not take that as a reason to stop. He took it as a description of the work still .. |
...
| 2 | b2ch48:26 | Sang-hoon took a table again rather than a room, and this time Georgij understood it as .. |
| 2 | b2ch48:30 | "You have had three weeks," said Sang-hoon. |
| 2 | b2ch48:46 | Sang-hoon put his cup down. |
| 2 | b2ch48:78 | Sang-hoon did not say anything at all for a while. |
| 2 | b2ch48:98 | Sang-hoon sat back. |
| 2 | b2ch48:106 | "Give it to me," said Sang-hoon. |
| 2 | b2ch48:126 | "I would have it done by Thursday." Sang-hoon turned his glass a quarter turn and left i.. |
| 2 | b2ch48:146 | Sang-hoon did not move. |
| 2 | b2ch48:162 | Sang-hoon heard it too. |
| 2 | b2ch48:186 | "Then what do I do," said Sang-hoon, "because I am not going to sit in a restaurant for .. |
| 2 | b2ch48:194 | Sang-hoon looked at the folded sheet and did not touch it. |
| 2 | b2ch48:214 | Sang-hoon looked at him for a long moment. |
| 2 | b2ch48:246 | "I know it was not on purpose. You have not done anything on purpose since Saturday morn.. |
...
- `b2ch42:178` (Tag 2) - three
- `b2ch42:236` (Tag 2) - four, one, three
- `b2ch42:244` (Tag 2) - eleven, one
- `b2ch42:256` (Tag 2) - eleven
...
- `b2ch42:442` (Tag 2) - one
- `b2ch43:6` (Tag 5) - one
- `b2ch43:50` (Tag 5) - four, three, two
- `b2ch43:74` (Tag 5) - nine
- `b2ch43:190` (Tag 5) - one
- `b2ch43:234` (Tag 5) - one, six
- `b2ch43:254` (Tag 5) - one, two
- `b2ch43:262` (Tag 5) - six
- `b2ch43:322` (Tag 5) - one, three, two
- `b2ch44:6` (Tag 8) - two
...
| 3 | b2ch40:172 | "It is both," said Jang. "In this kind of work it is almost always both, and I have stop.. |
...
| 5 | b2ch43:106 | "The Friday delivery is a standing order. The grocer's man told me the number himself, i.. |
| 5 | b2ch43:118 | "He has been on that round for six years, and he said it without me asking, because a ma.. |
| 5 | b2ch43:122 | Neither of them said anything for a moment. Georgij could hear a road behind Jang, and a.. |
| 5 | b2ch43:126 | "That is the whole of it," said Jang. "I want to be exact about what it is not. It is no.. |
| 5 | b2ch43:146 | "Yes," said Jang. "That is the size of it." |
| 5 | b2ch43:154 | Jang did not say anything to that, which is how he takes it when somebody has noticed. |
| 5 | b2ch43:182 | *And it is not his road. She said that in front of Jang on the twenty-first and she was .. |
...
| 2 | b2ch48:34 | "I have had three weeks and I have an answer, and it is not the one you asked me for." G.. |
...
- `b2ch43:106` (Tag 5) - nine, one
- `b2ch43:118` (Tag 5) - four, six
- `b2ch43:182` (Tag 5) - eleven, twenty
...
| 9 | b2ch09:252 | "Mrs Jeon at the settlement desk, who is out in seven weeks anyway and who I am going to.. |
...
| 38 | b2ch26:218 | "I was given that name on the twenty-fifth of October by a man called Hong, at a table, .. |
...
| 3 | b2ch51:154 | "Mr Ku takes you and Mr Ku stays outside for the whole of it, and he is not there to pro.. |
...
| 11 | b2ch20:36 | Nam Byung-hee has two trucks, no chair, no work and no association standing. Mr Kwon sig.. |
| 17 | b2ch22:94 | "There is a woman in Ulsan called Nam Byung-hee," said Georgij. "She is fifty-eight. On .. |
...
| 2 | b2ch48:206 | "And if he goes to Choi Dae-ho the same afternoon." |
...
| 17 | b2ch22:78 | "I took money for a service that this house had been selling since before I sat down in .. |
| 17 | b2ch22:86 | "Nobody was hurt," said Mr Byun. |
| 17 | b2ch22:98 | Mr Byun looked politely interested. |
| 17 | b2ch22:118 | Mr Byun did not move for about four seconds. |
| 17 | b2ch22:146 | Mr Byun stood there. |
| 17 | b2ch22:170 | Mr Byun went and stood at the window. |
| 17 | b2ch22:182 | "He is not like the others," said Mr Byun. "I want that considered. I want it taken into.. |
| 17 | b2ch22:188 | Mr Byun said it anyway. |
| 17 | b2ch22:214 | "He said there was a lot going out that evening and there would be no invoice for it. I .. |
| 17 | b2ch22:220 | "He gave me the money. In the room. From his own pocket, in an envelope that had already.. |
| 17 | b2ch22:238 | Mr Byun went into another room and was gone for about two minutes, and came back with a .. |
| 17 | b2ch22:258 | Mr Byun stood in the middle of his sitting room. |
| 17 | b2ch22:274 | "Twenty-six years," said Mr Byun, behind him. "Do you know what that building was like w.. |
